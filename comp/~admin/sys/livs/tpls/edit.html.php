<?php if(!defined('WEB_ROOT')) exit();?><?php if(empty(Action::$classqueue["Livs"])){ require_once(file_exists("do/LivsAct.class.php")?"do/LivsAct.class.php":"~do/LivsAct.class.php"); Action::$classqueue["Livs"] = new LivsAct(); }Action::$classqueue["Livs"]->getsimlives();Action::$classqueue["Livs"]->getcompents();?>
<div class="ui-state-default left-tree-top" style="margin-right:0;">
	<span><span class="mx-sysmenu"></span> > <?php echo Template::$_tplval['info']['livname']; ?> > 修改</span>
</div>
<div class="mx-toolbar">
	<a href="javascript:;" class="button" brurl="sys/livs/?app.html"><span class="mx-sysmenu-tree"></span></a>
</div>
<div class="mx-formpanel">
	<form class="ajaxform" method="post" action="sys/livs/do/?Livs-edit/id/<?php echo Template::$_tplval['info']['id']; ?>.html">
