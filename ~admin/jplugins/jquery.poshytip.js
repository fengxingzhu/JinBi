...
(function($) {
		...
		update: function(content, dontOverwriteOption) {
			...
			var self = this,
				newContent = typeof content == 'function' ?
					...
					content == '[itip]' ? this.$elm.data('title.poshytip') : content;
	...
	$.fn.poshytip.defaults = {
		content: 		'[itip]',	// content to display ('[itip]', 'string', element, function(updateCallback){...}, jQuery)
