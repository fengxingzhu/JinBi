...
{
	session_start();
	return empty($_SESSION['MXUSER_INFO'])?false:true;//权限判断
...
*/
$__webroot = dirname(dirname(dirname(dirname(__FILE__))));
require($__webroot.'/~edw/conf/define.php');
$baseUrl = WEB_APP.'asset/ckuploads/';
